...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { content: @check.content, email: @check.email, name: @check.name } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { content: @check.content, email: @check.email, name: @check.name } }
